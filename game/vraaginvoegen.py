class vraaginvoegen:
    ...
    def setup(self, buttonPressedGetVragen, buttonPressedVraagInvoegen, errorScreenInput, buttonPressedResetten1, buttonPressedResetten2):
        #BACKGROUND
        #global bgImg
        #global evil32
        size(1280,720)
        ...
        self.draw(buttonPressedGetVragen, buttonPressedVraagInvoegen, errorScreenInput, buttonPressedResetten1, buttonPressedResetten2, bgImg, evil32)

    def draw(self, buttonPressedGetVragen, buttonPressedVraagInvoegen, errorScreenInput, buttonPressedResetten1, buttonPressedResetten2, bgImg, evil32):
        textFont(evil32)
        #AANVRAAG VRAGEN
